...
input_sample = pd.DataFrame({"date": pd.Series(["2000-1-1"], dtype="datetime64[ns]"), "instant": pd.Series([0], dtype="int64"), "season": pd.Series([0], dtype="int64"), "yr": pd.Series([0], dtype="int64"), "mnth": pd.Series([0], dtype="int64"), "weekday": pd.Series([0], dtype="int64"), "weathersit": pd.Series([0], dtype="int64"), "temp": pd.Series([0.0], dtype="float64"), "atemp": pd.Series([0.0], dtype="float64"), "hum": pd.Series([0.0], dtype="float64"), "windspeed": pd.Series([0.0], dtype="float64"), "casual": pd.Series([0], dtype="int64"), "registered": pd.Series([0], dtype="int64")})
try:
